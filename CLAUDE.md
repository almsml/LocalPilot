...
| 文档 | 内容 |
|------|------|
| [学习路径](docs/学习路径.md) | 5 天从零读懂整个项目的结构化学习路线 |
| [压力面试题库](docs/压力面试题库.md) | 13 道分布式系统压力面试题 + 完整答案 |
| [面试展示文案](docs/面试.md) | 面试官视角的完整展示脚本 + 12 个模块速查表 |
| [简历文案](docs/简历文案.md) | 4 个版本简历 bullet（通用/后端/系统/全栈）+ STAR 话术 |
| [STAR 叙述](docs/STAR.md) | 完整 STAR 法则面试叙述（情境→任务→行动→结果） |
